...
from ankislop.db.dao.decks import DeckItemDAO, DeckTaskDAO
from ankislop.db.dao.outbox import OutboxEventDAO
from ankislop.db.errors import (
    DAOError,
    DAOIntegrityError,
...
from ankislop.dto.deck_item import DeckItemCreateDTO, DeckItemDTO
from ankislop.dto.deck_task import DeckTaskCreateDTO, DeckTaskDTO
from ankislop.dto.outbox_event import OutboxEventCreateDTO
from ankislop.services.errors import (
    ConflictError,
    DataAccessError,
    InvalidInputError,
...
class DeckTaskService:
    ...
    def derive_deck_name(options: dict) -> str:
        return f"AnkiSlop::{options.get('sentence_lang', 'english')}→{options.get('translation_lang', 'russian')}"
