...
@pytest_asyncio.fixture
async def decktask_service(sessionmaker, deckitem_dao, decktask_dao, fake_publisher):
    return DeckTaskService(sessionmaker, deckitem_dao, decktask_dao, fake_publisher)
